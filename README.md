...
[![smithery badge](https://smithery.ai/badge/yok_akademik_mcp_apisiz)](https://smithery.ai/server/yok_akademik_mcp_apisiz)
...
To install yok_akademik_mcp_apisiz for Claude Desktop automatically via [Smithery](https://smithery.ai/server/yok_akademik_mcp_apisiz):

```bash
npx -y @smithery/cli install yok_akademik_mcp_apisiz --client claude
```
